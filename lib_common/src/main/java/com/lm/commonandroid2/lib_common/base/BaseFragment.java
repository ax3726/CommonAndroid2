...
import com.lm.commonandroid2.lib_common.R;
import com.lm.commonandroid2.lib_common.databinding.WidgetLayoutEmptyBinding;
...
import com.lm.commonandroid2.lib_common.widget.TitleBarLayout;
...
public abstract class BaseFragment<P extends BaseFragmentPresenter, B extends ViewDataBinding> extends RxFragment implements BaseFragmentView {
    ...
    protected StateModel mStateModel = null;//
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
        ...
        mStateModel = new StateModel(aty);
        if (isTitleBar()) {
